...
All three are whole and unedited, deliberately. A fixture someone
...
`npm run smoke:sources` and `npm run smoke:search` are what check them against reality. When it disagrees
